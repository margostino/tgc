...
namespace AlumnoEjemplos.Dunedains
{
    public static class Configuracion
    {
        ...
        {
             //Modifiers            
            GuiController.Instance.Modifiers.addBoolean("debug", "Activar Debug", false);
            GuiController.Instance.Modifiers.addFloat("speedShip", 0f, 2f, 0.1f);            
            GuiController.Instance.Modifiers.addFloat("speedShoot", 1f, 10f, 5f);            
            ...
            currentCamHeight = 50f;
            currentCamForward = 50f;
            GuiController.Instance.Modifiers.addFloat("tCamH", 1, 100000, currentCamHeight);
            GuiController.Instance.Modifiers.addFloat("tCamF", 1, 100000, currentCamForward);
        ...
        private static void crearVariables()
        {
            ...
            GuiController.Instance.UserVars.addVar("rCamDis");
            GuiController.Instance.UserVars.addVar("rCamCen");            
        }
